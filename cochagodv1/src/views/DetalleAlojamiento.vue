<template>
  <div id="page-top">
    <div class="flex">
      <div
        class="hidden md:block w-64 bg-purple-500/10 text-gray-800 fixed h-screen p-4 overflow-y-auto shadow-md"
      >
        <nav>
          <ul class="space-y-3">
            <li>
              <a
                href="#page-top"
                class="px-3 py-2 rounded hover:bg-purple-400 hover:text-white transition-colors flex"
                :class="{ 'bg-purple-400 text-white': activeTerm === 'page-top' }"
            ...
            <li v-for="(term, index) in terms" :key="index">
              <a
                :href="'#' + term.id"
                class="block px-3 py-2 rounded hover:bg-purple-400 hover:text-white transition-colors"
                :class="{ 'bg-purple-400 text-white': activeTerm === term.id }"
      ...
      <div class="w-full bg-white text-gray-800 md:ml-64" id="main-content">
        ...
        <div class="px-4">
          <div id="acceptance" class="mb-12 scroll-mt-24">
            <h2 class="text-2xl font-semibold mb-4 text-purple-500 flex items-center">
              Descripción
            </h2>
          ...
          <div id="contact" class="mb-12 scroll-mt-24">
            ...
            <a
              ...
              target="_blank"
              class="text-gray-600 hover:text-purple-500 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              class="text-gray-600 hover:text-purple-500"
            >
              {{ alojamiento.email }}
            </a>
            <br />

            <i class="fab fa-facebook-f text-purple-500 mr-2"></i>
            <a
