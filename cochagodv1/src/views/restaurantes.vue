<template>
  <div class="bg-gray-50 min-h-screen">
    ...
    <header class="bg-teal-600 text-white shadow-md">
      <div class="container mx-auto px-4 py-6">
        ...
        <p class="mt-2 text-teal-100">
          Descubre los mejores establecimientos de Cochabamba
        </p>
      </div>
    </header>
    ...
    <main class="container mx-auto px-4 py-8">
      ...
      >
        <!-- Card Negocio - Ejemplo con datos dinámicos -->
        <div
        ...
        >
          <div class="relative">
            <img
              :src="business.image || 'https://via.placeholder.com/600x400?text=Negocio'"
              :alt="business.name"
...
// Categorías y zonas (deberían venir del backend)
...
// Obtener negocios del backend (simulado)
const fetchBusinesses = async () => {
  try {
    // En producción sería una llamada API real:
    ...
    businesses.value = [
      ...
      // Más negocios se agregarían aquí...
    ];
...
const filteredBusinesses = computed(() => {
  ...
  switch (sortBy.value) {
    case "rating":
      ...
      break;
    case "newest":
      // Asumiendo que tenemos un campo 'createdAt'
