    ...
    <div class="flex">
      ...
      <div class="w-full bg-white text-gray-800 md:ml-64" id="main-content">
        <div class="relative mb-10">
          ...
          <div
            v-else
            class="w-full h-[320px] rounded shadow bg-gradient-to-br from-teal-400 to-orange-400"
          />

          <div
            class="absolute -bottom-10 left-4 bg-teal-400 border-2 border-white shadow-lg w-[160px] h-[160px] flex items-center justify-center rounded-full"
          >
            <img
