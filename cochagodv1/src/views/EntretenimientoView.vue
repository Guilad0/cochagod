  ...
  <div class="">
    <header class="shadow-md mt-13">
      <div class="container mx-auto px-4 py-6">
        <h1 class="text-3xl font-bold text-pink-500">
          Nuestros Caseritos de Negocios de Entretenimiento.
        </h1>
        <p class="mt-2 text-pink-400">
          Ya sea un paseo por el Teleférico, una cita en un bar con terraza o una noche
          intensa en un boliche, Cocha te espera.
        </p>
      </div>
    </header>
    ...
    <section class="bg-white shadow-sm top-15 z-10">
      <div class="container mx-auto px-4 py-4">
        <div class="flex flex-col md:flex-row gap-4 items-start md:items-center">
          <div
            class="search-box flex-1 bg-white rounded-lg border border-pink-300 flex items-center px-4 py-2 transition-all w-88"
          >
    ...
    <main class="container mx-auto px-4 py-8">
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center">
          ...
          <button
            ...
            :class="[
              'p-2',
              viewMode === 'grid' ? 'text-pink-600' : 'text-gray-400 hover:text-pink-600',
            ]"
          >
          ...
          <button
            ...
            :class="[
              'p-2',
              viewMode === 'list' ? 'text-pink-600' : 'text-gray-400 hover:text-pink-600',
            ]"
          >
      ...
      <div v-if="filteredBusinesses.length === 0 && !loading" class="text-center py-12">
        ...
        <button
          @click="resetFilters"
          class="mt-4 px-4 py-2 bg-pink-600 text-white rounded-md hover:bg-pink-700 transition-colors"
        >
          Reiniciar filtros
        </button>
      </div>
      ...
      >
        ...
        >
          <div class="relative">
            ...
            <div
              class="absolute bottom-2 right-2 bg-white text-pink-500 text-sm font-bold px-2 py-1 rounded flex items-center"
            >
              ...
              <div class="flex flex-row items-center">
                <i
                  :class="[
                    'mr-2',
                    business.phone
                      ? 'fas fa-phone-alt text-pink-500'
                      : 'fas fa-clock text-pink-500',
                  ]"
                ></i>
...
.business-card:hover {
  ...
  box-shadow: 0 10px 25px rgba(255, 0, 119, 0.1);
}
