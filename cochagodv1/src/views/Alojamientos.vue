  ...
  <div class="">
    <header class="shadow-md mt-13">
      <div class="container mx-auto px-4 py-6">
        ...
        <p class="mt-2 text-purple-500">
          Descubre los mejores establecimientos para alojarte de Cochabamba
        </p>
      </div>
    </header>
    ...
    <section class="bg-white shadow-sm sticky top-15 z-10">
      <div class="container mx-auto px-4 py-4">
        <div class="flex flex-col md:flex-row gap-4 items-start md:items-center">
          <div
            class="search-box flex-1 bg-white rounded-lg border border-purple-300 flex items-center px-4 py-2 transition-all w-full"
          >
      ...
      >
        ...
        >
          <div class="relative">
            ...
            <div
              class="absolute bottom-2 right-2 bg-white text-purple-500 text-sm font-bold px-2 py-1 rounded flex items-center"
            >
              ...
              <div class="flex flex-row items-center">
                <i
                  :class="[
                    'mr-2',
                    business.phone
                      ? 'fas fa-phone-alt text-purple-500'
                      : 'fas fa-clock text-purple-500',
                  ]"
                ></i>
...
.search-box:focus-within {
  box-shadow: 0 0 0 3px rgba(127, 20, 251, 0.2);
}
</style>
