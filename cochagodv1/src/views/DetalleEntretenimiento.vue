<template>
  <div id="page-top">
    <div class="flex">
      <div
        class="hidden md:block w-64 bg-pink-500/10 text-gray-800 fixed h-screen p-4 overflow-y-auto shadow-md"
      >
        <nav>
          <ul class="space-y-3">
            <li>
              <a
                href="#page-top"
                class="px-3 py-2 rounded hover:bg-pink-400 hover:text-white transition-colors flex"
                :class="{ 'bg-pink-400 text-white': activeTerm === 'page-top' }"
            ...
            <li v-for="(term, index) in terms" :key="index">
              <a
                :href="'#' + term.id"
                class="block px-3 py-2 rounded hover:bg-pink-400 hover:text-white transition-colors"
                :class="{ 'bg-pink-400 text-white': activeTerm === term.id }"
      ...
      <div class="w-full bg-white text-gray-800 md:ml-64" id="main-content">
        <div class="relative mb-10">
          ...
          <div
            v-else
            class="w-full h-[320px] rounded shadow bg-gradient-to-br from-pink-500 to-purple-400"
          />

          <div
            class="absolute -bottom-10 left-4 bg-pink-400 border-2 border-white shadow-lg w-[160px] h-[160px] flex items-center justify-center rounded-full"
          >
            <img
        ...
        <div class="px-4">
          ...
          <div id="contact" class="mb-12 scroll-mt-24">
            ...
            <i class="fab fa-facebook-f text-pink-600 mr-2"></i>
            <a
