    ...
    <div class="flex">
      ...
      <div class="w-full bg-white text-gray-800 md:ml-64" id="main-content">
        <div class="relative mb-10">
          <img
            class="w-full h-[220px] rounded shadow bg-pink-400 object-cover"
            :src="coverImages[1]?.url_image || '/img/cochago.png'"
            alt="Imagen grande"
          />

          <div
            class="absolute -bottom-10 left-4 bg-pink-400 border-2 border-white p-3 shadow-lg w-[160px] h-[160px] flex items-center justify-center rounded-full"
          >
            <img
