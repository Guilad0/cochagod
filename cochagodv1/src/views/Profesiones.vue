...
const items = ref([
  ...
  {
    id: 2,
    nombre: "Fabiola Veronica Carvajal Garcia",
    descripcion: "Abogada",
    imagen: "/img/restaurante.jpg",
  },
  {
    id: 3,
    nombre: "Fabio Mauricio Gomez Salah",
    descripcion: "Tecnico plomero, pintor y carpinteria en melamina",
    imagen: "/img/restaurante.jpg",
  },
]);
